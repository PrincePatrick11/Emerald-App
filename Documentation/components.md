...
| `FaviconGlyph` | just the emoji-or-image glyph of `Favicon`, without the picker (same file). Fixed 20px — the `lg` size variant was dropped along with its one caller | `value` |
