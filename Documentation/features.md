...
Settings are **per vault** — stored in that vault's own `settings.json`, not shared app-wide. Switching vaults switches the whole configuration with it, and a vault folder copied to another machine keeps its own settings. The window has five pages:
