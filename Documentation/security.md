...
`src-tauri/src/lib.rs` registers **28 commands**. The security-relevant ones are discussed in their own sections below; this inventory exists so a new command cannot hide among undocumented ones.
